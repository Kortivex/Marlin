...
#define MACHINE_UUID "a0fd5b2b-8854-4201-996c-6b34d7de060f"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  26.93
    #define DEFAULT_Ki   2.33
    #define DEFAULT_Kd  77.74
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 49.41
  #define DEFAULT_bedKi  8.68
  #define DEFAULT_bedKd 187.50
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 451.6 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.8  // (mm) Distance from real junction edge
...
#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_NOZZLE_TEMP 210
